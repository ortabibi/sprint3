export function MailFolderList({ filterByStatus, onSetStatus, onOpenCompose, isSideMenuOpen, onCloseSideMenu }) {

    return <React.Fragment>
        <section className={`side-filter ${isSideMenuOpen ? 'show-side-menu' : ''}`}>
        ...
        {isSideMenuOpen && <div className="side-menu-backdrop" onClick={onCloseSideMenu}></div>}
    </React.Fragment>
}